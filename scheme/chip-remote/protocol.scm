...
(define (rate->termios n)
  (cond
   ((and      termios-B50 (= n      50))      termios-B50)
   ((and      termios-B75 (= n      75))      termios-B75)
   ((and     termios-B110 (= n     110))     termios-B110)
   ((and     termios-B134 (= n     134))     termios-B134)
   ((and     termios-B150 (= n     150))     termios-B150)
   ((and     termios-B200 (= n     200))     termios-B200)
   ((and     termios-B300 (= n     300))     termios-B300)
   ((and     termios-B600 (= n     600))     termios-B600)
   ((and    termios-B1200 (= n    1200))    termios-B1200)
   ((and    termios-B1800 (= n    1800))    termios-B1800)
   ((and    termios-B2400 (= n    2400))    termios-B2400)
   ((and    termios-B4800 (= n    4800))    termios-B4800)
   ((and    termios-B9600 (= n    9600))    termios-B9600)
   ((and   termios-B19200 (= n   19200))   termios-B19200)
   ((and   termios-B38400 (= n   38400))   termios-B38400)
   ((and   termios-B57600 (= n   57600))   termios-B57600)
   ((and  termios-B576000 (= n  576000))  termios-B576000)
   ((and  termios-B115200 (= n  115200))  termios-B115200)
   ((and  termios-B230400 (= n  230400))  termios-B230400)
   ((and  termios-B460800 (= n  460800))  termios-B460800)
   ((and  termios-B500000 (= n  500000))  termios-B500000)
   ((and  termios-B921600 (= n  921600))  termios-B921600)
   ((and termios-B1000000 (= n 1000000)) termios-B1000000)
   ((and termios-B1152000 (= n 1152000)) termios-B1152000)
   ((and termios-B1500000 (= n 1500000)) termios-B1500000)
   ((and termios-B2000000 (= n 2000000)) termios-B2000000)
   ((and termios-B2500000 (= n 2500000)) termios-B2500000)
   ((and termios-B3000000 (= n 3000000)) termios-B3000000)
   ((and termios-B3500000 (= n 3500000)) termios-B3500000)
   ((and termios-B4000000 (= n 4000000)) termios-B4000000)
   (else (throw 'invalid-baudrate n))))
...
localhost, empty ports default the 1234."
  ...
  (define (rate lst)
    (let ((n (length lst)))
      (if (= n 1)
          termios-B921600
          (rate->termios (string->number (cadr lst))))))
  (cond ((file-ish? target) (let ((parts (string-split target #\@)))
                              (make-cr-connection! #:serial   (file parts)
                                                   #:baudrate (rate parts))))
