...
(define (set-clkout-fall-posn regval value)
  (format #t "WARNING: Unhandled second level access function!~%")
  (format #t "         `set-clkout-fall-posn' generated with:~%")
  (format #t "             type: function~%")
  (format #t "             var:  fall-posn-decode~%")
  ...
  (set-clkout-fall-posn-bits regval value))

(define (set-clkout-rise-posn regval value)
  (format #t "WARNING: Unhandled second level access function!~%")
  (format #t "         `set-clkout-rise-posn' generated with:~%")
  (format #t "             type: function~%")
  (format #t "             var:  rise-posn-decode~%")
  (format #t "You probably want to write a special-purpose function instead!~%")
  (format #t "This function falls back to the first-level access function!~%")
  (set-clkout-rise-posn-bits regval value))
