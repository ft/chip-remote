...
(define-public (set-rb-dac-value conn value)
  (let ((data (split-word value 2 8)))
;; WARNING: rb-dac-value has no #:split function!
;;          Inserted generic splitter! Make sure that's OK!
;; The generic splitter does not do any sanitising on `data'.
;; Consider using (with-constraints ...)
    'no-data
;; WARNING: No data for rb-dac-value-high...
;; Entry:
;; (rb-dac-value
;;   (sources
;;     (rb-dac-value-high . 388)
;;     (rb-dac-value-low . 389))
;;   (logic . word)
;;   (split #f #f))
;; combined-data:
;; ((sysref-div-low
...
(define-public (set-id-vendor conn value)
  (let ((data (split-word value 8 8)))
;; WARNING: id-vendor has no #:split function!
;;          Inserted generic splitter! Make sure that's OK!
;; The generic splitter does not do any sanitising on `data'.
;; Consider using (with-constraints ...)
    'no-data
;; WARNING: No data for id-vendor-high...
;; Entry:
;; (id-vendor
;;   (sources
;;     (id-vendor-high . 12)
...
;;    (regval value)))
    ...
    'no-data
;; WARNING: No data for id-vendor-low...
;; Entry:
;; (id-vendor
;;   (sources
;;     (id-vendor-high . 12)
...
(define-public (set-id-product conn value)
  (let ((data (split-word value 8 8)))
;; WARNING: id-product has no #:split function!
;;          Inserted generic splitter! Make sure that's OK!
;; The generic splitter does not do any sanitising on `data'.
;; Consider using (with-constraints ...)
    'no-data
;; WARNING: No data for id-product-high...
;; Entry:
;; (id-product
;;   (sources
;;     (id-product-high . 4)
...
;;    (regval value)))
    ...
    'no-data
;; WARNING: No data for id-product-low...
;; Entry:
;; (id-product
;;   (sources
;;     (id-product-high . 4)
